...
import { updateEvent, UpdateEventData } from '../lib/eventService';
...
const EditEventModal: React.FC<EditEventModalProps> = ({ isOpen, onClose, onEventUpdated, eventData }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Success - notify parent component to refresh events list
      if (onEventUpdated) {
        onEventUpdated();
      }
      ...
      setErrors({
        title: error instanceof Error ? error.message : 'Failed to update event. Please try again.'
      });
    } finally {
      ...
      >
        ...
        <div className="overflow-y-auto max-h-[90vh]">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-purple-500 p-6 sm:p-8">
            ...
            <p className="text-purple-100 mt-2">Update event information</p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">
                  Event Image (optional - leave unchanged if not updating)
                </label>
                ...
                >
                  {imagePreview ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-gray-400">
                      ...
                      <p className="text-lg font-medium mb-2">Upload New Event Image</p>
